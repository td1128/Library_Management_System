...
const ReturnForm = () => {
    ...
    const handleMemberSearch = async () => {
        ...
        console.log(`${import.meta.env.VITE_APP_API_URL}/${import.meta.env.VITE_APP_USER_PATH}/profile/${memberID}`)
        const res = await fetch(`${import.meta.env.VITE_APP_API_URL}/${import.meta.env.VITE_APP_USER_PATH}/profile/${memberID}`)
        .then(res => res.json())
    ...
    const handleBookSearch = async () => {
        setLoadingOverlay(true);
        const res = await fetch(`${import.meta.env.VITE_APP_API_URL}/${import.meta.env.VITE_APP_USER_PATH}/profile/get/library-card-details/${memberID}`)
        .then(res => res.json())
        setLoadingOverlay(false);
